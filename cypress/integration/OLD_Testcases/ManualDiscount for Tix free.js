...
describe('Test', function () {
    ...
    beforeEach('Login', function() {
      ...
      Login.loginEmail().type('bisiokonkwo@yahoo.com')
      Login.loginPassword().type('........')
      Login.save().click();
      
})

it('Ensure a Tix free user can not create more than 1 discount code  ',function(){
...
dc.saveButton().click()
dc.discountVisibility().click()
dc.addDiscount().click()
cy.get('.tix-pro__description > .u-button').should('be.visible')
